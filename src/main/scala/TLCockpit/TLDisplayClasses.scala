...
case class TLPackageDisplay(name: StringProperty, lrev: ObjectProperty[Int], rrev: ObjectProperty[Int],
...
case class TLUpdateDisplay(name: StringProperty, var status: StringProperty, lrev: StringProperty, rrev: StringProperty,
